...
namespace libRtlSdrSharp {
    ...
    public class LibraryWrapper {
        ...
        [DllImport(LibRtlSdr, EntryPoint = "rtlsdr_set_gpio", CallingConvention = CallingConvention.Cdecl)]
        public static extern int rtlsdr_set_gpio(IntPtr dev, int gpio_pin, int on);

        [DllImport(LibRtlSdr, EntryPoint = "rtlsdr_set_bias_tee", CallingConvention = CallingConvention.Cdecl)]
